...
public class QuerydslBasicTest {
    ...
    public void resultFetch() {
        ...
        Member fetchFirst = queryFactory
                .selectFrom(member)
                .fetchFirst(); // limit(1) 걸어서 fetchOne() 해주는 것
        ...
        result.getTotal();
        List<Member> results = result.getResults(); // 이걸 꺼내야지 data가 나옴

        long total = queryFactory
                .selectFrom(member)
                .fetchCount(); // member의 전체 개수 조회
    }
    ...
    public void sort() {
        ...
        List<Member> result = queryFactory
                ...
                // nullsLast는 해당 데이터가 null이면 마지막으로 정렬
                .fetch();
    ...
    public void join_on_filtering() {
        List<Tuple> result = queryFactory
                ...
                // member는 다 가져오고 team은 teamA인 것만 가져옴
                .fetch();
